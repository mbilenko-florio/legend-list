...
public class ALAutoLayoutViewManagerDelegate<T extends View, U extends BaseViewManagerInterface<T> & ALAutoLayoutViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public ALAutoLayoutViewManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
